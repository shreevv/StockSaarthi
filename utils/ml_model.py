...
def generate_recommendation(stock_data, predictions_df):
    ...
    prediction_slope = predictions_df['Predicted_Close'].iloc[-1] - predictions_df['Predicted_Close'].iloc[0] if not predictions_df.empty and len(predictions_df)>1 else 0
